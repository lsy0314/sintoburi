...
그런 다음 Raspberry Pi3 장치에 Ubuntu OS를 설치하십시오.
...
### 소프트웨어 수동 실행
* launcher.c로 실행하는 방법
우선, gcc 명령으로 launcher.c를 컴파일하십시오. 그런 다음 컴파일하여 생성된 `launcher` 파일을 실행하십시오.
```bash
$ cd sintoburi
...
<img src=https://github.com/lsy0314/sintoburi/blob/master/pic/demo02.png width=350 height=400 border=0 />
...
* 공통: 웹앱 디자인작업, 테스트/디버깅
* 개발방법:우리는 학교 학업을 진행하면서 개발을 협업하기 위하여 원활한 의사소통 수단이 필요하였습니다. 그래서 우리는 지구상의 모든 개발자들이 활발하게 널리 쓰고있는 github 개발 호스팅 사이트를 이용하기로 하였습니다. 우리는 github.com 사이트를 이용하여 실시간으로 각자의 개발 진행 상황을 공유하며 체크하였습니다. 진행상황을 꼼꼼히 체크할수 있게되어 공동 개발 작업을 편하게 할수 있었습니다. 우리는 팀웍과 공동 작업의 산출물인 프로그램의 완성도를 높이기 위하여 github.com 서비스를 효과적으로 이용할수 있었습니다. 
